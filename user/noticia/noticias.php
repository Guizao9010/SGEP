...
if (isset($_SESSION['user_id']) && isset($_SESSION['email'])) {
    ...
    $list_noticia = $noticia_obj->listarNoticiaUsuario($_SESSION['user_id']);
    $idU = $user_data->id;
} else {
    header('Location: ../../logout.php');
    exit;
    ...
    <div class="flex-1 ml-50 p-8">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    <?php foreach ($list_noticia as $noticia) : ?>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                if (isset($_POST['nome']) && isset($_POST['descricao']) && isset($_POST['data'])) {
                    $result = $noticia_obj->cadastroNoticia($_POST['nome'], $_POST['descricao'], $_POST['data'], $_SESSION['user_id']);
