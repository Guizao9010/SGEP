...
?>
                ...
                <div class="relative overflow-x-auto form-container">
                    ...
                    <form action="" method="POST">
                        <div class="mb-6">
                            ...
                            <input type="text" id="nome" name="nome" value="<?php echo $noticia_atual[0]['nm_noticia']; ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required>
                        </div>
                        <div class="mb-6">
                            <label for="conteudo" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Conteúdo</label>
                            <input type="text" id="conteudo" name="conteudo" value="<?php echo $noticia_atual[0]['ds_noticia']; ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required>
                        </div>
                        <div class="mb-6">
    ...
    $resultadoAtualizacao = $noticia_obj->atualizarNoticia($id, $noticiaName, $noticiaConteudo, $noticiaDate, $_SESSION['user_id']);
