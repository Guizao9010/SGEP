        ...
        <tbody>
          <?php foreach ($list_units as $unit) : ?>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <td class="px-6 py-4">
                <!-- Modal Editar -->
                <a href="atualizaUnit.php?id=<?= $unit['id_unidade'] ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline" type="button">Editar</a>
                <a href="deleteUnit.php?id=<?= $unit['id_unidade'] ?>" class="font-medium text-red-600 dark:text-red-500 hover:underline" type="button">Excluir</a>
              </td>
            </tr>
          <?php endforeach; ?>
        </tbody>
